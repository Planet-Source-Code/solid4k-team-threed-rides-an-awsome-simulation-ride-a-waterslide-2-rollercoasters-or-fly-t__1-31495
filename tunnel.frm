...
Begin VB.Form TunnelForm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label1 
         Caption         =   "Note: If the rides get slow, hold down a key.  It works."
         Height          =   255
         Left            =   4080
         TabIndex        =   7
         Top             =   240
...
'3D Rides
'Brought to you by Solid!
'Made to help others...
'And to test my skills for a game I'm making...
'A game where you build your own RollerCoasters...
'Then ride them.  Loops, curves, water splashes, the works.
'Cool eh?
'www.angelfire.com/az3/solid4k
'----------------------------------------------------------------------------------------------------------------------
Option Explicit
...
Const SPEED = 0.007                                      ' Amount to increment camera position along
...
'Note: There is a space infront of each ride because
'          it looks odd when the border and text colide...
'Note: I dunno how to spell colide ;x
Select Case Ridez.Caption
Case " Water Slide"
     Ridez.Caption = " Roller Coaster 1"
Case " Roller Coaster 1"
     Ridez.Caption = " Roller Coaster 2"
Case " Roller Coaster 2"
     Ridez.Caption = " Fly Thru Space"
End Select
End Sub

Private Sub Command4_Click()
'If you don't know what this is, try going back to 3rd grade.
IMCanvas1.SetFocus
...
Private Sub Form_Load()
    ...
    Me.Show
    Let TEXTUREPATH$ = App.Path & "\texture.bmp"
    cSTOP = False 'Declairs that we're still on Go
...
Private Sub Form_Resize()
    ...
    IMCanvas1.Height = Me.ScaleHeight - 700
    Frame1.Top = Me.Height - Frame1.Height - 410
    Frame1.Width = Me.Width - 125
    Cleanup
    IMCanvas1.StartWindowed
    InitDevice
...
Sub InitDevice()
    ...
    '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~set texture!
    Set m_Tex = IMCanvas1.CreateTextureSurface(TEXTUREPATH$, 0, 0, 0)
...
Private Sub Ridez_Change()
Select Case Ridez.Caption
Case " Water Slide"
     TEXTUREPATH$ = App.Path & "\texture.bmp"
Case " Roller Coaster 1"
     TEXTUREPATH$ = App.Path & "\texture2.bmp"
Case " Roller Coaster 2"
     TEXTUREPATH$ = App.Path & "\blah.bmp" ' I dunno, I got an error when I named it texture3 =/
Case " Fly Thru Space"
     TEXTUREPATH$ = App.Path & "\texture4.bmp"
End Select
'Okay, lets apply our new ride...
InitDevice
'Now, to prevent nasty lag, we'll set focus to the ride...
IMCanvas1.SetFocus
End Sub

Private Sub Speedz_Change()
